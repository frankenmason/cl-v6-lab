...
## 0. Baseline v3 (정정 — Mason 2026-04-13 TG 1363 기준)

**실제 CL 오류율: 16.0%** (12건 / 75 논의 Turn)

근거:
- 인벤토리 12건 전수 = 실제 오류 비교군 (외부 감지 + CL 자체 반성 모두 동등)
- CL 자체 인식 오류도 오류 raw (Mason 기준)
- hook 단독(2.97%)은 부분 지표일 뿐

이전 보고 정정:
| 보고 시점 | 수치 | 상태 |
|---------|:---:|:---:|
| 초기 자체 보고 | 13.8% | 근사 (정확) |
| Phase 6 keyword grep | 0.92% | undercount |
| 정정 v2 (record type) | 2.97% | hook 단독, 부분 |
| **정정 v3 (Mason 기준)** | **16.0%** | ✅ 최종 |
